...
\end{equation}
for $h=0,\dots, H$ forecast horizons. $r_{t+h}$ is federal funds rate and $\rho_{t+h}$ is the \citet{LW2003} natural interest rate.\footnote{I use \citet{HLW2023} updated version of the \citet{LW2003} natural rate estimation.}
...
The vector of controls, $Z$, consists of the 4 lags of the dependent variable, $r_{t+h}-\rho_{t+h}$, and 4 lags of the FED expected inflation, $\hat\pi_t$.
...
\begin{align}
    ...
    \log \mathit{Consumption}&=\alpha_0'+\alpha_1' R_0+\alpha_2'\nu+\beta_1' R_0\nu + \beta_2' R_0\nu^2
\end{align} 
The hypotheses of models in equations \vrefrange{eq:SizePersistenceRANK}{eq:SizePersistenceHANK} map into the tests of the signs of coefficients as follows:\footnote{Note that the elasticity of consumption with respect to size, $R_0$, is $-d\log \mathit{Consumption}/d R_0$, so the } 
...
Note that since these estimates are derived based on other estimates, the tests need to be based on bootstrap percentile-type confidence intervals 



\section{Results}
The estimated mean and differential response to a unit increase in inflation can be found in \vref{fig:LP}. The differential response is shown under the deviation of $\mathit{Hawk}_t$ from its mean equal to $2/12$, which is slightly higher than one standard deviation, and a standard choice in \citet{HIM2023}. The average and differential responses of  $r_t-\rho_t$ tend to be smaller compared to the estimation for federal funds rate of \citet{HIM2023}. However, they still are larger than zero up to 8th quarter. 
...
\begin{figure}[!ht]\centering
    ...
    \begin{subfigure}[b]{0.49\textwidth}
        ...
        \includegraphics[width=\linewidth]{AverageResponce.pdf}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.49\textwidth}
        \centering
        ...
        \includegraphics[width=\linewidth]{DifferentialResponce.pdf}
    \end{subfigure}
...
\begin{table}[!htbp] \centering 
  ...
  \cline{2-7} 
  \\[-1.8ex] & lead(dR, 2) & lead(dR, 4) & lead(dR, 8) & lead(dR, 12) & demeaned\_HAWK & I(demeaned\_HAWK \textasteriskcentered  expected\_inflation) \\ 
  \\[-1.8ex] & \textit{instrumental} & \textit{instrumental} & \textit{instrumental} & \textit{instrumental} & \textit{OLS} & \textit{OLS} \\ 
   & \textit{variable} & \textit{variable} & \textit{variable} & \textit{variable} & \textit{} & \textit{} \\ 
  \\[-1.8ex] & (1) & (2) & (3) & (4) & (5) & (6)\\ 
  \hline \\[-1.8ex] 
   expected\_inflation & 0.968$^{***}$ & 1.114$^{***}$ & 1.127$^{*}$ & 0.678 & 0.054 & 0.121 \\ 
    & (0.232) & (0.275) & (0.613) & (0.501) & (0.036) & (0.090) \\ 
    & & & & & & \\ 
   demeaned\_HAWK & $-$2.071 & $-$2.344 & $-$1.612 & 1.833 &  &  \\ 
    & (1.314) & (1.753) & (2.657) & (2.871) &  &  \\ 
    & & & & & & \\ 
   demeaned\_HAWK\_IV &  &  &  &  & 0.738$^{***}$ & 0.803$^{***}$ \\ 
    &  &  &  &  & (0.069) & (0.170) \\ 
    & & & & & & \\ 
   lag(dR, 1) & 0.779$^{***}$ & 0.747$^{***}$ & 0.310$^{**}$ & $-$0.132 & 0.010 & $-$0.007 \\ 
    & (0.125) & (0.169) & (0.151) & (0.123) & (0.018) & (0.045) \\ 
    & & & & & & \\ 
   lag(dR, 2) & $-$0.068 & $-$0.124 & $-$0.003 & $-$0.062 & $-$0.011 & $-$0.073 \\ 
    & (0.135) & (0.221) & (0.189) & (0.207) & (0.026) & (0.065) \\ 
    & & & & & & \\ 
   lag(dR, 3) & 0.244$^{***}$ & $-$0.208 & $-$0.345$^{***}$ & $-$0.289 & 0.005 & 0.033 \\ 
    & (0.078) & (0.156) & (0.122) & (0.209) & (0.026) & (0.064) \\ 
    & & & & & & \\ 
   lag(dR, 4) & $-$0.141 & 0.216 & 0.265 & 0.122 & 0.019 & $-$0.014 \\ 
    & (0.105) & (0.147) & (0.189) & (0.209) & (0.018) & (0.043) \\ 
    & & & & & & \\ 
   lag(expected\_inflation, 1) & 0.070 & $-$0.156 & $-$0.258 & $-$0.167 & $-$0.026 & $-$0.133 \\ 
    & (0.371) & (0.204) & (0.249) & (0.290) & (0.053) & (0.129) \\ 
    & & & & & & \\ 
   lag(expected\_inflation, 2) & $-$0.420$^{*}$ & $-$0.161 & $-$0.521 & $-$0.067 & 0.005 & 0.082 \\ 
    & (0.240) & (0.442) & (0.343) & (0.273) & (0.053) & (0.130) \\ 
    & & & & & & \\ 
   lag(expected\_inflation, 3) & $-$0.323 & $-$0.175 & $-$0.074 & 0.024 & $-$0.014 & $-$0.046 \\ 
    & (0.431) & (0.215) & (0.164) & (0.094) & (0.053) & (0.130) \\ 
    & & & & & & \\ 
   lag(expected\_inflation, 4) & $-$0.230 & $-$0.500 & 0.024 & 1.017$^{***}$ & 0.040 & 0.337$^{***}$ \\ 
    & (0.327) & (0.361) & (0.486) & (0.311) & (0.038) & (0.094) \\ 
    & & & & & & \\ 
   expected\_inflation:demeaned\_HAWK & 0.999 & 1.470$^{**}$ & 2.077$^{**}$ & 0.153 &  &  \\ 
    & (0.653) & (0.748) & (1.054) & (1.328) &  &  \\ 
    & & & & & & \\ 
   expected\_inflation:demeaned\_HAWK\_IV &  &  &  &  & $-$0.101$^{***}$ & 0.148$^{***}$ \\ 
    &  &  &  &  & (0.021) & (0.051) \\ 
    & & & & & & \\ 
   Constant & $-$0.185 & $-$0.176 & $-$0.152 & $-$2.080$^{*}$ & $-$0.223$^{***}$ & $-$0.747$^{***}$ \\ 
    & (0.640) & (0.826) & (1.073) & (1.210) & (0.037) & (0.091) \\ 
    & & & & & & \\ 
  \hline \\[-1.8ex] 
  Observations & 192 & 190 & 186 & 182 & 194 & 194 \\ 
  R$^{2}$ & 0.841 & 0.751 & 0.597 & 0.592 & 0.669 & 0.794 \\ 
  Adjusted R$^{2}$ & 0.832 & 0.735 & 0.571 & 0.566 & 0.649 & 0.781 \\ 
  Residual Std. Error & 1.465 (df = 180) & 1.845 (df = 178) & 2.371 (df = 174) & 2.404 (df = 170) & 0.211 (df = 182) & 0.520 (df = 182) \\ 
  F Statistic (df = 11; 182) &  &  &  &  & 33.438$^{***}$ & 63.673$^{***}$ \\ 
  \hline 
  \hline \\[-1.8ex] 

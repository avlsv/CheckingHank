    ...
    \begin{tabular}{@{\extracolsep{5pt}}lcc} 
      ...
      \hline \\[-1.8ex] 
       Size $(R_0)$  & $-$0.687 & $-$0.114 \\ 
        ...
        & & \\ 
       Persistence $(\nu)$ & $-$0.100 & 1.223 \\ 
        & ($-$0.682, 0.680)& ($-$3.598, 4.968)    \\ 
        & & \\ 
        $\nu^2$ &  & $-$1.042 \\ 
        &  &  ($-$4.271, 4.336) \\ 
        & & \\ 
       $R_0\times \nu$ & 0.765 & $-$1.628 \\ 
        & ($-$0.187, 1.527) &   ($-$6.095,  4.186)     \\ 
        & & \\ 
        $R_0\times \nu^2$ &  & 2.435 \\ 
        &  &  ($-$4.017, 6.784) \\ 
        & & \\ 
      ...
      F Statistic & 33.062$^{***}$ & 20.067$^{***}$ \\ 
      \hline 
      \hline \\[-1.8ex] 
      \end{tabular} 
    \begin{tablenotes}[flushleft]
    \item[] \textit{Note:} 95\% percentile intervals are in parenthesis for 10,000 replications of Block bootstrap with block lengths having a geometric distribution with mean $16$.
  \end{tablenotes}
\end{threeparttable}
  \end{table} 
...
\begin{table}[!htbp] \centering \scriptsize
    \begin{threeparttable}
    \caption{Responce of FOMC to increase in expected inflation} 
    \label{tab:full_coef} 
  ...
  \hline \\[-1.8ex] 
   ...
   & (0.125) & (0.169) & (0.167) & (0.151) & (0.147) & (0.018) & (0.045) \\ 
    ...
    & & & & & & \\ 
    $r_{t-3}-\rho_{t-3}$  & $-$0.208 & $-$0.002 & $-$0.345$^{***}$ & $-$0.206$^{**}$ & 0.005 & 0.033 \\ 
...
\noindent\textbf{FRED.} I measure consumption expenditure by chained 2017 dollars, seasonally adjusted personal consumption expenditures per capita (A794RX0Q048SBEA) calculated by the U.S. Bureau of Economic Analysis (quarterly). 
One of the components of use effective federal funds rate (DFF)
is used in combination with the shadow rate of \citet{WuXia2016}. 
To measure $r_t$ I take the minimum of me 

\noindent\textbf{Shadow Rate.}
